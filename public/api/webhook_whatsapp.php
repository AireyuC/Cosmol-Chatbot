...
class WebhookWhatsAppEndpoint extends Controller
{
    public function handleRequest()
    {
        ...
        try {
            ...
            // 3. Ruteo hacia los Flow Handlers
            if ($sysMessage) {
                ...
                $authFlow = new AuthFlowHandler($sessionService, $socioService);
                $whatsappPayload = $authFlow->handle((string)$telefono, (string)$tipoMensaje, $contenido, $intentos);
            } elseif ($estadoActual === 'MAIN_MENU') {
                $menuFlow = new MenuFlowHandler($sessionService, $socioService, $reconexionService);
                ...
                $reconexionFlow = new ReconexionFlowHandler($sessionService, $reconexionService, $mediaService);
                ...
                $reclamoFlow = new ReclamoFlowHandler($sessionService, $reclamoService, $mediaService);
