...
- **Backend API:** PHP Puro (Vanilla PHP v7.4 o v8.1).
- **Infraestructura de Despliegue (Docker):** Se oficializa el uso de **Docker** para contenerizar tanto n8n como la API PHP, garantizando un entorno escalable e idéntico para producción.
...
- **Base de Datos:**
  ...
  - **Desarrollo Local:** XAMPP (MySQL/MariaDB) simulando un espejo del sistema SAI.
